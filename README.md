...
- Deeper look
    * https://medium.com/hackernoon/kotlin-a-deeper-look-8569d4da36f
...
- Evolution of JS
    ...
    * https://www.educative.io/blog/javascript-es6-tutorial-a-complete-crash-course
- this
...
- Accessing Memory in Java (Unsafe)
...
- GC types
    * https://en.wikipedia.org/wiki/Tracing_garbage_collection#Copying_vs._mark-and-sweep_vs._mark-and-don't-sweep
- ZGC
...
- Java GC
    ...
    * http://www.infoq.com/presentations/Understanding-Java-Garbage-Collection (Doubling the memory will decrease the GC
      CPU usage by 2 - 53:00 min)
...
- podman, buildah, skopeo, umoci
    * https://podman.io
    * https://buildah.io/
    * https://github.com/containers/skopeo
    * https://umo.ci
    * https://opensource.com/article/18/12/podman-and-user-namespaces
    * https://pacroy.medium.com/try-podman-buildah-and-skopeo-instead-of-docker-c45a0e9394b0
- runc
...
- SaaS
    * https://www.logicmonitor.com/blog/what-is-the-difference-between-saas-based-and-cloud-based
- CRM
